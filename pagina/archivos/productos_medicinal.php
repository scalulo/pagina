<?php
    ...
    if (!$conexion) {
        ...
        $query = "select nombre, precio, descripcion, marca, img1 from producto where id_producto = $idproducto";
...
document.querySelector('.button-wrapper').addEventListener('click', function() {
        ...
        setTimeout(function() {
            document.querySelector('.button-wrapper').classList.remove('clicked');
        }, 200);
    });
    </script>
</body>
